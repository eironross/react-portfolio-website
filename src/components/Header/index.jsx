      ...
      <header>
        <div className="content">
          ...
          <h1 ref={myRef} className={isVisible ? "animation show" : "animation hidden"}>
            I am <span id="name-header">Eiron Ross </span>
            , a self-taught developer based in Bulacan, PH.
            <div className="determiner">
              <span className="determiner-word">Aspiring to be a</span>
              <span className="determiner-word">I am a licensed </span>
            </div> 
            <div className="words">
              <span className="career-path">Software</span>
              <span className="career-path">Electrical</span>
            </div>
            Engineer.
          </h1>
          <div ref={myRef} className={isVisible ? "animation show socials" : "animation hidden socials"}>
              <a className="icon-hover" href="https://github.com/eironross" target="_blank">
              ...
              <a className="icon-hover" href="https://linkedin.com/in/eironross" target="_blank">
          ...
          <Arrow ref={myRef} className={ isVisible ? "arrow dot show" : "arrow dot hidden"} />
